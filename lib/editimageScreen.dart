...
class _EditimageScreenState extends State<EditimageScreen> {
  ...
  Future<void> _saveImage() async {
    try {
      ...
      print(result);
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Screenshot saved to gallery')));
    } catch (e) {
      print("Error saving screenshot: $e");
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Error saving screenshot')));
    }
  }
}
